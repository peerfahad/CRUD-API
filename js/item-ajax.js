...
$(".crud-submit").click(function(e){
    ...
    var title = $("#create-item").find("input[name='father_name']").val();
    var description = $("#create-item").find("textarea[name='email']").val();
    var title = $("#create-item").find("input[name='phone']").val();
    ...
    if(name != '' && father_name != '' && email != '' && phone != ''){
        $.ajax({
            ...
            $("#create-item").find("textarea[name='email']").val('');
...
$("body").on("click",".edit-item",function(){
    ...
    $("#edit-item").find("textarea[name='email']").val(email);
...
$(".crud-submit-edit").click(function(e){
    ...
    var title = $("#edit-item").find("input[name='father_name']").val();
    var title = $("#edit-item").find("input[name='email']").val();
     var title = $("#edit-item").find("input[name='phone']").val();
